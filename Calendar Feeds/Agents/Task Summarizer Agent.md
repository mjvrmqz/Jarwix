...
For each incomplete event, ask User the following questions directly in chat:

1. "How did this task go for you?"
2. "Reason?"
3. "Considerations for next time?"
4. "Which of these steps did you get done?" — list the Actionable Steps as options for User to confirm

Do this one event at a time. Wait for User's reply before moving to the next.

---

## Step 3 — Write Results to Notion

Once User replies for an event:
